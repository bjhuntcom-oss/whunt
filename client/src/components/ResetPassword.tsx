  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-xl font-semibold text-[#e0e0e0]">Set New Password</h2>
      ...
      <div className="space-y-4">
        <div className="space-y-1.5">
          <label className="text-sm font-medium text-[#999]">New Password</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 border border-[#252525] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"
              autoFocus
            />
            <button
              type="button"
