    ...
    <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#e0e0e0] mb-6 leading-[1.1] tracking-tight animate-[fadeIn_0.7s_ease-out]">
          ...
          <p className="text-lg md:text-xl text-[#555] max-w-3xl mx-auto mb-12 leading-relaxed animate-[fadeIn_0.8s_ease-out]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 max-w-3xl mx-auto">
            {stats.map((stat, index) => (
              <div
                key={index}
                className={`bg-[#0a0a0a]/80 backdrop-blur-sm p-6 rounded-2xl border border-[#1a1a1a] shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 animate-[fadeInUp_0.6s_ease-out] ${
                  currentStat === index
              ...
              >
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-[#e0e0e0] mb-1 tracking-tight">
                  {index === 0
                ...
                <p className="text-sm text-[#555] font-medium">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="text-center animate-[fadeIn_1s_ease-out]">
          <p className="text-sm text-[#555] mb-6 font-medium uppercase tracking-wider">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6">
            {["Shopify", "WooCommerce", "Salesforce", "HubSpot", "Zapier"].map(
              (brand, index) => (
                <div
                  key={index}
                  className="px-5 py-2.5 rounded-lg text-sm font-medium text-[#555] bg-[#050505] border border-[#1a1a1a] transition-colors duration-200 hover:text-[#555] hover:border-[#1a1a1a]"
                >
                  {brand}
                </div>
              )
