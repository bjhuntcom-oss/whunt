    ...
    <div className="pt-16">
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-slate-50 via-white to-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          <h1 className="text-4xl md:text-6xl font-bold text-[#e0e0e0] mb-6 tracking-tight">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-[#0a0a0a] p-8 md:p-10 rounded-2xl border border-[#1a1a1a]/80 shadow-sm">
              <h2 className="text-2xl font-bold text-[#e0e0e0] mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div className="relative">
                    <input
                      ...
                      className="peer w-full px-4 py-3.5 border border-[#1a1a1a] rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-all duration-200 placeholder-transparent bg-[#050505]/50 focus:bg-[#0a0a0a]"
                      placeholder={t("contactUs.form.fields.name")}
                      required
                    />
                    <label className="absolute left-4 -top-2.5 text-xs font-medium text-[#555] bg-[#0a0a0a] px-1 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-sm peer-placeholder-shown:text-[#555] peer-placeholder-shown:bg-transparent peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-emerald-600 peer-focus:bg-[#0a0a0a]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3.5 border border-[#1a1a1a] rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-all duration-200 bg-[#050505]/50 focus:bg-[#0a0a0a] appearance-none"
                      required
                    >
                      <option value="">
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="peer w-full px-4 py-3.5 border border-[#1a1a1a] rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-400 transition-all duration-200 placeholder-transparent bg-[#050505]/50 focus:bg-[#0a0a0a] resize-none"
                ...
                <div className="space-y-4">
                  {contactInfo.map((info, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="flex items-start space-x-4 p-5 rounded-xl border border-[#1a1a1a] bg-[#050505]/50 hover:border-emerald-200/60 hover:bg-emerald-50/30 transition-all duration-200"
                      >
                        ...
                        <div>
                          ...
                          <p className="text-[#999] font-medium text-sm mt-0.5">{details}</p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50/80">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#e0e0e0] mb-3 tracking-tight">
          ...
          <div className="space-y-3">
            {faqQuestions.map((faq, index) => (
              <div
                key={index}
                className="bg-[#0a0a0a] rounded-xl border border-[#1a1a1a]/80 overflow-hidden transition-all duration-200 hover:border-[#252525]/80"
              >
                <button
                  onClick={() => setOpenFaq(openFaq === index ? null : index)}
                  className="w-full flex items-center justify-between p-5 text-left"
                >
                  <h3 className="font-semibold text-[#e0e0e0] text-sm pr-4">{faq.q}</h3>
                  <ChevronDown
                ...
                >
                  <p className="px-5 pb-5 text-[#555] text-sm leading-relaxed">
                    {faq.a}
                  </p>
                </div>
              </div>
