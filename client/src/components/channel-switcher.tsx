...
export function ChannelSwitcher() {
  ...
  if (isLoading || isActiveChannelLoading) {
    return <div className="w-full h-9 bg-[#0a0a0a] animate-pulse rounded" />;
  }
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription className="text-[#999]">
                There's a problem with the connection for channel <strong className="text-[#e0e0e0]">{healthWarningChannel}</strong>.
              </DialogDescription>
            </DialogHeader>
