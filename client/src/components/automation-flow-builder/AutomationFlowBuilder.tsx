        ...
        <div className="flex-1">
          ...
          >
            <MiniMap
              ...
              className="!bg-[#0a0a0a] !border !border-[#1a1a1a] !rounded-lg !shadow-sm"
            />
            <Controls className="!bg-[#0a0a0a] !border !border-[#1a1a1a] !rounded-lg !shadow-sm" />
            <Background color="#e2e8f0" gap={20} size={1} />
          </ReactFlow>
        </div>
      </div>

      <div className="col-span-3 border-l border-[#1a1a1a] bg-[#0a0a0a]">
        <ConfigPanel
