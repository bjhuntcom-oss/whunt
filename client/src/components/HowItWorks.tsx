      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#555] mt-1 text-sm leading-relaxed">
              ...
              <div className="space-y-3">
                {steps[activeStep].details.map((detail, idx) => (
                  <div key={idx} className="flex items-center space-x-3">
                    ...
                    <span className="text-[#999] text-sm">{detail}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="px-5 py-2.5 border border-[#1a1a1a] rounded-xl text-[#999] text-sm font-medium hover:bg-[#050505] disabled:opacity-40 disabled:cursor-not-allowed transition-all"
              >
          ...
          <div className="relative">
            <div className="bg-gray-950 p-5 rounded-3xl shadow-xl">
              ...
              <div className="bg-[#0a0a0a] rounded-2xl p-2 min-h-[250px] overflow-hidden">
                <img
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-br from-violet-50 via-white to-fuchsia-50 p-10 rounded-3xl border border-violet-100/50">
            ...
            <p className="text-[#555] mb-8 max-w-lg mx-auto">{cta.joinText}</p>
            <Link
              href="/contact"
