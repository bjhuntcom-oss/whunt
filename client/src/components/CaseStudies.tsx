    ...
    <div className="pt-16">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-[#e0e0e0] mb-6 inline-flex gap-2">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {caseStudies.map((study) => (
              <div
                key={study.id}
                className="bg-[#0a0a0a] rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all hover:-translate-y-1"
              >
                <div className="relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-[#0a0a0a]/90 backdrop-blur-sm px-3 py-1 rounded-full">
                ...
                <div className="p-8">
                  ...
                  <p className="text-[#999] mb-6">{study.challenge}</p>
      ...
      {selectedStudy && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#0a0a0a] rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="relative">
              <img
              ...
              <button
                ...
                className="absolute top-4 right-4 bg-[#0a0a0a]/90 backdrop-blur-sm p-2 rounded-full hover:bg-[#0a0a0a] transition-colors"
              >
                ×
              </button>
            </div>
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4 text-[#999]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  ...
                  <p className="text-[#999]">{selectedStudy.solution}</p>
                </div>
                  ...
                  <div className="space-y-4">
                    {selectedStudy.results.metrics.map(
                      (metric: any, index: number) => (
                        <div key={index} className="bg-[#050505] p-4 rounded-lg">
              ...
              <div className="bg-blue-50 p-6 rounded-lg mb-8">
                <blockquote className="text-lg text-[#999] italic mb-4">
                  "{selectedStudy.testimonial.quote}"
                </blockquote>
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center">
                    <FaUserCircle className="text-[#999] text-3xl" />
                  </div>
              ...
              <div className="flex space-x-4">
                ...
                <button className="px-6 py-3 border border-[#252525] rounded-lg hover:bg-[#050505] transition-colors flex items-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050505]">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-[#e0e0e0] mb-12">
            {t("caseStudies.stats.heading")}
          </h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="bg-[#0a0a0a] p-6 rounded-xl shadow-lg">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="w-fit
             bg-[#0a0a0a] text-green-600 px-8 py-4 rounded-xl font-bold hover:bg-[#0a0a0a] transition-all transform hover:scale-105 shadow-xl"
          >
