  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-xl font-semibold text-[#e0e0e0]">Verify Your Email</h2>
        <p className="text-sm text-[#555]">
          We've sent a 6-digit code to <span className="font-medium text-[#999]">{maskedEmail}</span>
        </p>
      </div>
      ...
      <div className="flex justify-center gap-3" onPaste={handlePaste}>
        {otp.map((digit, index) => (
          <input
            ...
            className="w-12 h-14 text-center text-xl font-semibold border-2 border-[#252525] rounded-lg 
