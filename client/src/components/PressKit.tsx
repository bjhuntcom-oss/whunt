    ...
    <div className="pt-16">
              ...
              <div className="grid grid-cols-2 gap-6">
                {Object.entries(companyInfo).map(([key, value]) => (
                  <div key={key} className="text-center">
                    ...
                    <div className="text-[#999] text-sm capitalize">
                      {key.replace(/([A-Z])/g, " $1")}
                    </div>
                  </div>
                ))}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {keyStats.map((stat, index) => (
              <div
                key={index}
                className="bg-[#0a0a0a] p-6 rounded-xl shadow-lg text-center"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {assets.map((category, index) => (
              <div key={index} className="bg-[#050505] p-8 rounded-2xl">
                ...
                <div className="space-y-4">
                  {category.items.map((item, itemIndex) => (
                    <div
                      key={itemIndex}
                      className="flex items-center justify-between bg-[#0a0a0a] p-4 rounded-lg"
                    >
                      <div>
                ...
                <button className="w-full mt-6 bg-gray-200 text-[#999] py-3 rounded-lg hover:bg-gray-300 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {executiveTeam.map((exec, index) => (
              ...
              >
                ...
                <p className="text-[#999] text-sm">{exec.bio}</p>
              </div>
            ))}
          </div>
        </div>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div className="flex-1">
                    <div className="text-sm text-[#555] mb-2">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-[#0a0a0a]/10 backdrop-blur-sm p-8 rounded-2xl">
