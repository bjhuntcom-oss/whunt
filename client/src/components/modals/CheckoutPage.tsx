...
const CheckoutModal: React.FC<CheckoutModalProps> = ({
  ...
  const getProviderIcon = (providerKey: string) => {
    ...
    switch (key) {
      ...
      default:
        return <Shield className="w-6 h-6 sm:w-7 sm:h-7 text-[#999]" />;
    }
  };
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-5">
          ...
          <div className="p-3 sm:p-4 bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            <div className="flex items-start gap-2 sm:gap-3 mb-2 sm:mb-3">
              <div className="p-1.5 sm:p-2 bg-[#0a0a0a] rounded-lg flex-shrink-0">
                <IconComponent className="w-4 h-4 sm:w-5 sm:h-5 text-[#999]" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="text-base sm:text-lg font-bold text-[#e0e0e0] truncate">
                  {plan.name}
                </h3>
                <p className="text-xs sm:text-sm text-[#999] line-clamp-2">
                  {plan.description}
                </p>
              </div>
            </div>
            <div className="flex items-center justify-between text-xs sm:text-sm pt-2 sm:pt-3 border-t border-blue-200">
              <span className="text-[#999]">Billing Period:</span>
          ...
          <div>
            <h3 className="text-sm sm:text-base font-semibold text-[#e0e0e0] mb-2 sm:mb-3">
              Included Features:
            </h3>
            <ul className="space-y-1.5 sm:space-y-2">
              {plan.permissions && (
                <>
                  <li className="flex items-center gap-2 text-xs sm:text-sm text-[#999]">
                      ...
                      >
                        <div className="flex flex-col items-center gap-1.5 sm:gap-2">
                          ...
                          <div className="text-center">
                            <span className="text-[10px] sm:text-xs font-medium text-[#e0e0e0] block">
                              {provider.name}
                            </span>
          ...
          <div className="flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-[#999]">
