...
const DemoPreviewModal: React.FC<DemoPreviewModalProps> = ({
    ...
    return (
      <div className="flex items-center justify-between text-sm mt-1">
        ...
        <div className="flex items-center gap-2">
          <code className="text-[#e0e0e0]">{value}</code>
          ...
          >
            {copied ? (
              ...
              <Copy size={16} className="text-[#555]" />
            )}
          </button>
        </div>
      </div>
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden pt-5">
      ...
      >
        <div className="flex w-full max-w-2xl  flex-col overflow-hidden rounded-xl bg-[#0a0a0a] shadow-2xl  ">
          {/* Header */}
          <div
          ...
          >
            {finalLogo && (
              <img
                src={finalLogo}
                className="mb-2 h-10 rounded bg-[#0a0a0a] border object-contain"
                alt="Logo"
              />
            )}
          ...
          <div className="p-6">
            {/* Docs Link */}
            {docsLink && (
              <div className="mb-4 text-base text-[#999]">
                Visit our docs:{" "}
                <a
                  href={docsLink}
                  target="_blank"
            ...
            <div className="mb-4 rounded-lg border border-slate-200 bg-slate-50 p-4 text-[15px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                ...
                <div className="rounded-lg bg-[#0a0a0a] p-3 shadow-sm border">
              ...
              {superAdmin && (
                <div className="rounded-lg bg-[#0a0a0a] p-3 shadow-sm border mt-2">
          ...
          {/* Support Email */}
          {supportEmail && (
            <div className="border-t border-[#1a1a1a] py-3 text-center text-sm">
              Support:{" "}
              <a
