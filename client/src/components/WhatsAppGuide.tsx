        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-[#050505] rounded-xl p-6">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-left transition-all ${
                          activeSection === section.id
                            ...
                            : "text-[#999] hover:bg-[#0a0a0a] hover:shadow-md"
                        }`}
                      >
              ...
              <div className="bg-[#0a0a0a]">
                ...
                <div className="space-y-8">
                  {currentContent.items && currentContent.items.length > 0 ? (
                    ...
                    <p className="text-[#555]">No content available</p>
                  )}
                </div>
                ...
                <div className="flex justify-between items-center mt-12 pt-8 border-t border-[#1a1a1a]">
                  <button
                    ...
                    className="flex items-center space-x-2 px-6 py-3 border border-[#252525] rounded-lg hover:bg-[#050505] disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {quickTips.map((tip, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#0a0a0a] p-6 rounded-xl shadow-lg hover:shadow-xl transition-all"
                >
