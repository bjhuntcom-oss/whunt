    ...
    <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-gray-50/50 to-white">
      <div className="max-w-7xl mx-auto">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 ${
                activeTab === index
                  ...
                  : "bg-[#0a0a0a] text-[#999] border border-[#1a1a1a] hover:border-[#252525] hover:shadow-sm"
              }`}
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          <div className="lg:col-span-2 bg-[#0a0a0a] rounded-2xl border border-[#1a1a1a] shadow-sm p-6 lg:p-8">
              ...
              <div className="space-y-3">
                {(features[activeTab].demo.features as string[]).map((feat: string, idx: number) => (
                  <div key={idx} className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-[#999]">{feat}</span>
                  </div>
                ))}
              </div>
            )}
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-950 p-6 rounded-3xl shadow-2xl">
              <div className="flex items-center space-x-2 mb-5">
                ...
                <span className="text-[#555] text-xs ml-3 font-medium tracking-wide uppercase">
              ...
              <div className="bg-[#0a0a0a] p-6 rounded-2xl">
                ...
                <div className="space-y-4">
                  {features[activeTab].demo.features && Array.isArray(features[activeTab].demo.features) &&
                    (features[activeTab].demo.features as string[]).slice(0, 3).map((feat: string, idx: number) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-[#050505] rounded-xl">
                ...
                <div className="mt-6 bg-[#050505] p-4 rounded-xl">
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {additionalFeatures.map(
            (item: { title: string; desc: string }, index: number) => (
              <div
                key={index}
                className="group bg-[#0a0a0a] p-6 rounded-2xl border border-[#1a1a1a] shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
