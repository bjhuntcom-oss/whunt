    ...
    <div className="pt-16">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-blue-50">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-[#e0e0e0] mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <div key={index} className="bg-[#050505] p-6 rounded-xl">
      ...
      {/* Open Positions */}
      <section id="careers" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#050505]">
        <div className="max-w-7xl mx-auto">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-xl font-medium transition-all ${
                  selectedDepartment === dept.id
                    ...
                    : "bg-[#0a0a0a] text-[#999] hover:bg-[#0a0a0a] shadow-md"
                }`}
              >
                {dept.name}
              </button>
          ...
          <div className="space-y-6">
            {filteredJobs.map((job) => (
              <div
                key={job.id}
                className="bg-[#0a0a0a] p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all"
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-[#999] mb-4">
                    ...
                    <p className="text-[#999] mb-4">{job.description}</p>
          ...
          {filteredJobs.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-[#999] mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#050505] p-6 rounded-xl hover:bg-[#0a0a0a] transition-colors"
                >
                  ...
                  <p className="text-[#999]">{benefit.description}</p>
                </div>
              );
            })}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-[#0a0a0a] p-8 rounded-xl shadow-lg">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="bg-[#0a0a0a] text-green-600 px-8 py-4 rounded-xl font-bold hover:bg-[#0a0a0a] transition-all transform hover:scale-105 shadow-xl"
          >
