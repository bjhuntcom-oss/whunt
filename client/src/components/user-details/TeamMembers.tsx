...
export default function TeamMembers({ userId }: TeamMembersProps) {
      ...
      <div className="space-y-4">
        <div className="overflow-x-auto">
          <table className="min-w-full border border-[#1a1a1a] bg-[#0a0a0a] rounded-lg shadow-sm">
            <thead className="bg-[#0a0a0a] text-left text-sm font-semibold text-[#999]">
              <tr>
        ...
        <div className="flex items-center justify-center py-4 text-[#555]">
  ...
  {isDemoUser(user?.username) ? maskValue(member.email) : member.email}
                ...
                <td className="py-3 px-4 border-b text-[#555] text-xs">
