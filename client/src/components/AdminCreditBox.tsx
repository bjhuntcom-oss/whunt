...
export function AdminCreditBox() {
  ...
  if (isLoading) {
    return (
      <div className="rounded-lg border border-[#1a1a1a] bg-[#050505] p-3 animate-pulse h-28" />
    );
  }
  ...
  return (
    <div
      onClick={handleClick}
      className="rounded-lg border border-[#1a1a1a] bg-gradient-to-br from-blue-50/50 to-purple-50/50 p-3 shadow-sm hover:shadow-md hover:border-green-300 transition-all cursor-pointer"
    >
      <div className="flex justify-between items-center mb-2">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-semibold text-[#e0e0e0]">Plan</span>
        </div>
