    ...
    <div className="pt-16">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-blue-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* <p className="text-[#999]">Last Updated: {lastUpdated}</p> */}
        </div>
      </section>
                    ...
                    if (React.isValidElement(child) && child.props.title) {
                      ...
                      return (
                        <a
                          ...
                          className="block text-[#999] hover:text-green-600 transition-colors py-1 cursor-pointer"
                        >
                          {child.props.title}
                        </a>
                      );
...
export const PolicySection: React.FC<PolicySectionProps> = ({
  ...
  return (
    <section id={id} className="mb-12 scroll-mt-24">
      <h2 className="text-2xl font-bold text-[#e0e0e0] mb-6 border-b border-[#1a1a1a] pb-3">
        {title}
      </h2>
      <div className="text-[#999] leading-relaxed space-y-4">{children}</div>
    </section>
  );
};
