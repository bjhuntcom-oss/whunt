...
export function SignupPopupHandler() {
  ...
  if (isSubmitted) {
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9998] flex items-center justify-center p-4">
        <div className="bg-[#0a0a0a] rounded-2xl p-8 max-w-md w-full text-center animate-in fade-in zoom-in duration-300">
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9998] flex items-center justify-center p-4">
      <div className="bg-[#0a0a0a] rounded-2xl max-w-2xl w-full overflow-hidden animate-in fade-in zoom-in duration-300">
        <div className="relative">
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 p-2 hover:bg-[#0a0a0a] rounded-full transition-colors z-10"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="bg-gradient-to-br from-green-500 to-green-600 p-8 text-white">
              <div className="flex items-center space-x-3 mb-6">
                <div className="bg-[#0a0a0a]/20 p-2 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className="bg-[#0a0a0a]/20 p-1 rounded-full">
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    required
                  />
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-[#1a1a1a]">
                <div className="flex items-center justify-center space-x-4 text-sm text-[#555]">
