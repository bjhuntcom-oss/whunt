...
export function TemplateDialog({
  ...
  const renderPreview = () => {
    if (isAuthentication) {
      return (
        <div className="bg-[#0a0a0a] rounded-xl shadow-sm max-w-sm mx-auto overflow-hidden border border-[#1a1a1a]">
          ...
          <div className="border-t">
            {authType === "COPY_CODE" && (
              <button className="w-full py-2.5 px-4 text-[#00a884] text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#050505]">
        ...
        <div className="bg-[#0a0a0a] rounded-xl shadow-sm max-w-sm mx-auto overflow-hidden border border-[#1a1a1a]">
            ...
            <div className="bg-gradient-to-r from-amber-500 to-orange-500 px-4 py-2 flex items-center justify-between">
              ...
              <div className="flex gap-1">
                {["D", "H", "M"].map((unit) => (
                  <div
                    key={unit}
                    className="bg-[#0a0a0a]/20 rounded px-1.5 py-0.5"
                  >
          ...
          <div className="border-t divide-y">
            ...
            {watchedValues.buttons?.map((button, idx) => (
              <button
                key={idx}
                className="w-full py-2.5 px-4 text-[#00a884] text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#050505]"
              >
                {button.type === "URL" && (
                  <ExternalLink className="w-4 h-4" />
                )}
    ...
    if (isCarousel && carouselFields.length > 0) {
      ...
      return (
        <div className="max-w-sm mx-auto">
          <div className="bg-[#0a0a0a] rounded-xl shadow-sm overflow-hidden border border-[#1a1a1a] mb-2">
            {watchedValues.body && (
              <div className="p-4">
                <p className="text-sm whitespace-pre-wrap">
                  {watchedValues.body}
          ...
          {currentCard && (
            <div className="bg-[#0a0a0a] rounded-xl shadow-sm overflow-hidden border border-[#1a1a1a]">
              ...
              {currentCard.buttons && currentCard.buttons.length > 0 && (
                <div className="border-t divide-y">
                  {currentCard.buttons.map((btn: any, idx: number) => (
                    <button
                      key={idx}
                      className="w-full py-2 px-4 text-[#00a884] text-sm font-medium flex items-center justify-center gap-2 hover:bg-[#050505]"
                    >
                      {btn.type === "URL" && (
        ...
        {quickReplies && quickReplies.length > 0 && (
          <div className="flex flex-wrap gap-2 mt-2 justify-center">
            {quickReplies.map((button, idx) => (
              <button
                key={idx}
                className="px-4 py-2 text-[#00a884] text-sm font-medium bg-[#0a0a0a] rounded-full border border-[#1a1a1a] shadow-sm hover:bg-[#050505]"
              >
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="overflow-y-auto max-h-[calc(90vh-200px)] pr-4 space-y-4">
                ...
                <div className="space-y-4">
                  <h3 className="font-medium text-sm text-[#999]">
                    Basic Information
                  </h3>
                ...
                {isAuthentication && (
                  <div className="space-y-4 bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="flex items-center justify-between rounded-lg border p-3 bg-[#0a0a0a]">
                    ...
                    <div className="bg-[#0a0a0a] rounded-lg border p-3">
                      <Label className="text-sm font-medium">
                        Auto-generated Message
                      </Label>
                      <p className="text-sm mt-1 text-[#999] whitespace-pre-wrap">
                        {watchedValues.body}
                      </p>
                    </div>
                  </div>
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <div className="relative">
                                  ...
                                  />
                                  <span className="absolute right-3 top-1/2 -translate-y-1/2 text-xs text-[#555]">
                    ...
                    {isLTO && (
                      <div className="space-y-4 bg-orange-50 border border-orange-200 rounded-lg p-4">
                        ...
                        <FormField
                          ...
                          name="hasExpiration"
                          render={({ field }) => (
                            <FormItem className="flex items-center justify-between rounded-lg border bg-[#0a0a0a] p-3">
                              <div className="space-y-0.5">
                ...
                {isCarousel && (
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <h4 className="font-medium text-sm text-[#999]">
                    ...
                    {carouselFields.map((cardField, cardIdx) => (
                      <div
                        key={cardField.id}
                        className="border rounded-lg p-4 space-y-3 bg-[#050505]"
                      >
                        <div className="flex items-center justify-between">
                              ...
                              <FormControl>
                                <div className="relative">
                                  <Textarea
                                    ...
                                    {...field}
                                  />
                                  <span className="absolute right-2 bottom-2 text-xs text-[#555]">
              ...
              {/* Right side - Preview */}
              <div className="bg-[#050505] rounded-lg p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
