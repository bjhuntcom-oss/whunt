...
export function WebhookFlowDiagram() {
  return (
    <div className="bg-[#0a0a0a] rounded-lg border ">
      <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4 py-4">
        ...
        <div className="flex flex-col items-center text-center flex-1">
          ...
          <p className="text-xs text-[#555] mt-1">Via WhatsApp</p>
        </div>

        <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 text-[#555] rotate-90 sm:rotate-0" />
        ...
        <div className="flex flex-col items-center text-center flex-1">
          ...
          <p className="text-xs text-[#555] mt-1">Processes message</p>
        </div>
        ...
        <div className="flex flex-col items-center text-center flex-1">
          ...
          <p className="text-xs text-[#555] mt-1">To your URL</p>
        </div>
      ...
      <div className="mt-6 bg-[#050505] rounded-lg p-4 text-center sm:text-left overflow-x-auto">
        <p className="text-sm text-[#999] select-all  break-all ">
