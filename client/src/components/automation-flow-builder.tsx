...
function ConditionsNode({ data }: { data: BuilderNodeData }) {
  return (
    <Shell tint="bg-purple-500 border-purple-600">
      ...
      {data.matchType && (
        <div className="text-[11px] mt-1 bg-[#0a0a0a]/15 rounded px-2 py-1 inline-block">
...
function CustomReplyNode({ data }: { data: BuilderNodeData }) {
  return (
    <Shell tint="bg-orange-500 border-orange-600">
      ...
      {/* Media previews */}
      {data.imagePreview && (
        <div className="mt-2 rounded-lg overflow-hidden bg-[#0a0a0a]/10">
          <img
      ...
      {data.videoPreview && (
        <div className="mt-2 flex items-center gap-2 text-xs bg-[#0a0a0a]/10 rounded px-2 py-1">
      ...
      {data.buttons && data.buttons.length > 0 && (
        <div className="mt-2 space-y-1">
          {data.buttons.slice(0, 2).map((button) => (
            <div
              key={button.id}
              className="bg-[#0a0a0a]/20 text-xs px-2 py-1 rounded"
            >
              {button.text}
            </div>
          ))}
...
function UserReplyNode({ data }: { data: BuilderNodeData }) {
  return (
    <Shell tint="bg-pink-500 border-pink-600">
      ...
      {data.saveAs && (
        <div className="text-[11px] mt-2 bg-[#0a0a0a]/15 rounded px-2 py-1 inline-block">
  ...
  return (
    <>
      <button
        type="button"
        onClick={handleClick}
        className={`flex items-center gap-2 px-3 py-2 border rounded-md hover:bg-[#050505] ${className}`}
      >
        {children}
      </button>
      <input
      ...
      <ScrollArea className="flex-1 min-h-0">
        <div className="p-4 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs uppercase tracking-wide text-[#555]">
                Configure
              </div>
            ...
            <Card className="p-3 space-y-4">
              ...
              <div className="space-y-3">
                ...
                {(!d.buttons || d.buttons.length === 0) && (
                  <div className="text-sm text-[#555] italic border rounded-lg p-4 text-center">
              ...
              {(d.question || (d.buttons && d.buttons.length > 0)) && (
                <div className="border-t pt-4">
                  <Label className="text-xs text-[#555]">PREVIEW</Label>
                  <div className="bg-[#050505] rounded-lg p-3 mt-2">
                    {d.question && (
...
export default function AutomationFlowBuilderXYFlow({
  ...
  return (
    <div className="h-screen w-full grid grid-cols-12 bg-[#050505]">
      {/* Left Sidebar */}
      <div className="col-span-2 border-r bg-[#0a0a0a] flex flex-col">
        ...
        <ScrollArea className="p-2">
          <div className="space-y-4">
            <div>
              <div className="text-[11px] uppercase text-[#555] px-2 mb-1 flex items-center gap-2">
            ...
            <div>
              ...
              <div className="space-y-1">
                <button
                  ...
                  className="w-full text-left text-sm px-3 py-2 hover:bg-[#0a0a0a] rounded flex items-center gap-2"
                >
      ...
      <div className="col-span-8 flex flex-col">
        {/* Header */}
        <div className="bg-[#0a0a0a] border-b px-4 sm:px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      {/* Left Section */}
      <div className="flex flex-col sm:flex-row sm:items-center gap-4 w-full sm:w-auto">
        {/* Back Button */}
        <button
          onClick={onClose}
          className="text-[#999] hover:text-[#e0e0e0] self-start sm:self-center"
        >
        ...
        <div className="flex flex-col gap-2 min-w-[180px] px-4">
          <Label className="flex items-center gap-2 text-xs font-medium text-[#999]">
      ...
      <div className="flex items-center justify-end">
        ...
        <div className="bg-[#0a0a0a] border-t px-4 py-2 flex items-center gap-2">
          <span className="text-sm text-[#999]">Add step:</span>
          <Button
            size="sm"
            variant="secondary"
            onClick={() => addNode("conditions")}
      ...
      {/* Right Config Panel */}
      <div className="col-span-2 border-l bg-[#0a0a0a]">
        <ConfigPanel
