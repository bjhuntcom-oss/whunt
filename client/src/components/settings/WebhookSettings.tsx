            ...
            <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-4 space-y-4">
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <code className="text-xs bg-[#0a0a0a] dark:bg-gray-900 px-3 py-2 rounded border flex-1 break-all">
                    {webhookUrl}
                  </code>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  {activeConfig ? (
                    ...
                    <span className="text-sm text-[#555]">No active webhook config. Create one below.</span>
                  )}
                </div>
              </div>
          ...
          <CardContent>
            {webhooksLoading ? (
              ...
              <div className="text-center py-12">
                <Webhook className="w-12 h-12 mx-auto text-[#555] mb-4" />
              ...
              <div className="space-y-4">
                {webhookConfigs.map((webhook: WebhookConfig) => {
                  ...
                  return (
                    <div
                      key={webhook.id}
                      className="border border-[#1a1a1a] rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between"
                    >
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="space-y-2">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-2">
                            ...
                            <code className="text-xs bg-[#0a0a0a] px-2 py-1 rounded break-all flex-1">
                              {webhook.webhookUrl}
                            </code>
                            <Button
                              variant="ghost"
                          ...
                          {webhook.lastPingAt && (
                            <div className="text-sm text-[#555] truncate">
