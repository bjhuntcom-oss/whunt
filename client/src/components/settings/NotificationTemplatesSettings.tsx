        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex flex-col items-center justify-center py-8">
              <Loading />
              <p className="text-sm text-[#555] mt-2">Loading templates...</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        {templates.length === 0 ? (
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-[#555]">No notification templates found</p>
            </CardContent>
          </Card>
        ) : (
            ...
            <Card key={template.id} className="overflow-hidden">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-3 border rounded-lg bg-[#050505]">
