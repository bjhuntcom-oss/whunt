                ...
                >
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {/* In-App Toggle */}
                      <div className="flex items-center gap-3 rounded-lg border border-[#1a1a1a] bg-[#050505]/50 px-3 py-2.5">
                        <Switch
                        ...
                        <div className="flex items-start gap-2 min-w-0">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-[#555] mt-0.5">Shows in bell icon</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-[#1a1a1a] bg-[#050505]/50 px-3 py-2.5">
                        ...
                        <div className="flex items-start gap-2 min-w-0">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-[#555] mt-0.5">Sends to your email</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-3 rounded-lg border border-[#1a1a1a] bg-[#050505]/50 px-3 py-2.5">
                        ...
                        <div className="flex items-start gap-2 min-w-0">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-[#555] mt-0.5">Plays alert sound</p>
                          </div>
                        </div>
                      </div>
                    </div>
