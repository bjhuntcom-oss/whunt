          ...
          <div className="border border-[#1a1a1a] rounded-lg p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6">
              ...
              {displayData.updatedAt && (
                <div
                  className="mt-2 sm:mt-0 flex items-center text-sm text-[#555]"
                  aria-label={`${t(
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                ...
                <div className="p-4 bg-[#050505] rounded-lg border">
                  ...
                  {displayData.logo ? (
                    <div className="flex items-center space-x-3">
                      <img
                        ...
                        className="w-12 h-12 object-contain rounded border bg-[#0a0a0a]"
                        onError={(e) => {
                    ...
                    <div className="text-center py-4">
                      <Image className="w-8 h-8 mx-auto text-[#555] mb-2" />
...
<div className="space-y-3">
  ...
  <div className="p-4 bg-[#050505] rounded-lg border">
    {displayData.logo2 ? (
      ...
      <div className="text-center py-4">
        <Image className="w-8 h-8 mx-auto text-[#555] mb-2" />
        <p className="text-sm text-[#555]">No Logo 2 uploaded</p>
        <p className="text-xs text-[#555] mt-1">
                  ...
                  {displayData.favicon ? (
                    <div className="flex items-center space-x-3">
                      <img
                        ...
                        className="w-8 h-8 object-contain rounded border bg-[#0a0a0a]"
                        onError={(e) => {
                          e.currentTarget.style.display = "none";
                        }}
                      />
                    ...
                    <div className="text-center py-4">
                      <Globe className="w-8 h-8 mx-auto text-[#555] mb-2" />
                      <p className="text-sm text-[#555]">
      ...
      {displayData.title && (
        <Card>
          ...
          <CardContent>
            <div className="flex items-center space-x-4 p-6 border border-[#1a1a1a] rounded-lg bg-[#0a0a0a] shadow-sm">
              {displayData.logo && (
                <img
                  src={displayData.logo}
  ...
  />
              ...
              <div>
                ...
                {displayData.tagline && (
                  <p className="text-[#999] text-base mt-1">
                    {displayData.tagline}
                  </p>
                )}
              </div>
