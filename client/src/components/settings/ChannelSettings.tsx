    ...
    <>
        ...
        <CardContent>
          {channelsLoading ? (
            ...
            <div className="text-center py-12">
              <Smartphone className="w-12 h-12 mx-auto text-[#555] mb-4" />
            ...
            <div className="space-y-4">
              {(() => {
                ...
                <div
                  key={channel.id}
                  className="border border-[#1a1a1a] rounded-lg p-3 sm:p-4"
                >
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                    <div className="flex-1 min-w-0">
                          ...
                          {user?.username === "demouser" ? (
                            ...
                            <>
                              {(channel as any).healthDetails?.verified_name ? (
                                <span>
                                  {(channel as any).healthDetails.verified_name}
                                  <span className="text-sm font-normal text-[#555] ml-2">({channel.phoneNumber || channel.name})</span>
                                </span>
                              ) : (
                                channel.name
                              )}
                      ...
                      <div className="space-y-2 text-xs sm:text-sm text-[#999] mb-4">
                      ...
                      <div className="mt-4 pt-4 border-t border-[#1a1a1a]">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
                          <div className="flex items-center space-x-2">
                            <Shield className="w-5 h-5 text-[#999] flex-shrink-0" />
                        ...
                        {channel?.healthDetails &&
                          Object.keys(channel?.healthDetails).length > 0 && (
                            <div className="mt-3">
                                  ...
                                  {channel.healthDetails.status && (
                                    ...
                                    >
                                      <div className="flex items-center space-x-2 mb-1">
                                        ...
                                        />
                                        <span className="text-[10px] sm:text-xs font-medium text-[#999]">
                                          {t(
                              ...
                              {channel.lastHealthCheck && (
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mt-3 pt-3 border-t border-[#1a1a1a]">
                                  <p className="text-[10px] sm:text-xs text-[#555]">
            ...
            <>
              ...
              <div className="space-y-3 mt-2">
                ...
                <button
                  ...
                  className="w-full text-left p-4 border-2 border-[#1a1a1a] rounded-lg hover:border-blue-400 hover:bg-blue-50/50 transition-all group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-[#e0e0e0]">Connect Existing WhatsApp Business App</h3>
                    ...
                    <ArrowRight className="w-5 h-5 text-[#555] group-hover:text-blue-500 transition-colors mt-1" />
                  </div>
                </button>
                ...
                <button
                  ...
                  className="w-full text-left p-4 border-2 border-[#1a1a1a] rounded-lg hover:border-green-400 hover:bg-green-50/50 transition-all group"
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-[#e0e0e0]">Register New Number</h3>
                    ...
                    <ArrowRight className="w-5 h-5 text-[#555] group-hover:text-green-500 transition-colors mt-1" />
                  </div>
                </button>
              </div>
            </>
            ...
            <>
              ...
              <div className="space-y-4 mt-2">
                <div className="space-y-2.5">
                  <div className="flex items-start gap-3 p-3 bg-[#050505] rounded-lg">
                    <Smartphone className="w-4 h-4 text-[#999] mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-[#e0e0e0]">WhatsApp Business App v2.24.17+</p>
                      <p className="text-xs text-[#555]">Update your app to the latest version from your app store.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 p-3 bg-[#050505] rounded-lg">
                    <Clock className="w-4 h-4 text-[#999] mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-[#e0e0e0]">Active for at least 7 days</p>
                      <p className="text-xs text-[#555]">Your WhatsApp Business App should have been actively used for at least 7 days (ideally 1-2 months).</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 p-3 bg-[#050505] rounded-lg">
                    <Globe className="w-4 h-4 text-[#999] mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-[#e0e0e0]">Supported country</p>
                      <p className="text-xs text-[#555]">Nigeria and South Africa are currently not supported for coexistence.</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3 p-3 bg-[#050505] rounded-lg">
                    <Shield className="w-4 h-4 text-[#999] mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-sm font-medium text-[#e0e0e0]">Meta Business Account</p>
                      <p className="text-xs text-[#555]">You need a valid Meta Business Account to complete the connection.</p>
                    </div>
                  </div>
                </div>
      ...
      <Dialog open={showSuccessGuidance} onOpenChange={setShowSuccessGuidance}>
        <DialogContent className="sm:max-w-md">
          ...
          {lastConnectedCoexistence ? (
            <div className="space-y-3 mt-2">
              <p className="text-sm text-[#999] font-medium">Important things to know:</p>
            ...
            <div className="space-y-3 mt-2">
              <p className="text-sm text-[#999]">Your channel is ready! You can now:</p>
              <div className="space-y-2">
