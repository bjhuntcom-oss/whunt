...
function getNameStatusBadge(status: string | null | undefined) {
  ...
  switch (status) {
    ...
    case "EXPIRED":
      return <Badge className="bg-[#0a0a0a] text-[#999] border-[#1a1a1a]"><AlertTriangle className="w-3 h-3 mr-1" />Expired</Badge>;
    case "NONE":
      return <Badge className="bg-[#0a0a0a] text-[#555] border-[#1a1a1a]">None</Badge>;
    default:
