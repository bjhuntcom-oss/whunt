          ...
          <div className="space-y-4 mt-2">
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  readOnly
                  className="bg-[#050505] text-[#999] cursor-not-allowed"
                />
                {onOpenDisplayName && (
                  <Button
                    type="button"
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <div className="w-20 h-20 rounded-full bg-[#0a0a0a] flex items-center justify-center overflow-hidden border-2 border-[#1a1a1a]">
                  {photoPreview ? (
              ...
              <div className="text-sm text-[#555]">
                <p className="font-medium text-[#999]">Profile Photo</p>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                maxLength={139}
              />
              <p className="text-xs text-[#555]">{formData.about.length}/139 characters</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                rows={3}
              />
              <p className="text-xs text-[#555]">{formData.description.length}/512 characters</p>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {formData.websites.map((url, index) => (
                <div key={index} className="flex items-center gap-2">
                  <Input value={url} readOnly className="flex-1 text-sm bg-[#050505]" />
