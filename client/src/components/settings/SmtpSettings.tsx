    ...
    return (
      <Card>
        <CardContent className="p-6 flex flex-col items-center justify-center py-10">
          <Loading />
          <p className="text-sm mt-3 text-[#555]">Loading SMTP configuration...</p>
        </CardContent>
      </Card>
    );
  }
          ...
          <div className="border p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="mt-2 p-3 bg-[#0a0a0a] rounded border">
              ...
              <div>
                ...
                <p className="mt-2 p-3 bg-[#0a0a0a] rounded border">
                  {(displayData.secure === "true" || (displayData.secure as unknown) === true) ? "Enabled" : "Disabled"}
                </p>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-2 p-3 bg-[#0a0a0a] rounded border">
                  {displayData.logo ? (
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-[#555] break-all">{displayData.logo}</p>
                    </div>
                  ) : (
                    <p className="text-[#555]">No logo uploaded</p>
                  )}
                </div>
              </div>
            </div>
