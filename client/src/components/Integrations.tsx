    ...
    <div className="pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {integrations[activeCategory as keyof typeof integrations].map(
              (integration, index) => (
                <div
                  key={index}
                  className="bg-[#0a0a0a] p-6 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
                >
                  ...
                  <button className="w-full bg-[#0a0a0a] text-[#999] py-2 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium">
                    Connect Now
                  </button>
                </div>
              )
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-[#e0e0e0] mb-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="bg-[#0a0a0a] p-4 rounded-lg shadow-sm"
                  >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#0a0a0a] text-green-600 px-8 py-4 rounded-xl font-bold hover:bg-[#0a0a0a] transition-all transform hover:scale-105 shadow-xl">
              View API Documentation
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold hover:bg-[#0a0a0a] hover:text-green-600 transition-all">
