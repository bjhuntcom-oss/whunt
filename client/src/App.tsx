  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#050505]">
      <div className="text-center">
        <p className="font-mono text-[11px] text-[#ff3b3b] uppercase tracking-widest mb-3">403 — Forbidden</p>
        <h1 className="font-sans text-2xl font-800 font-black text-white mb-2 tracking-tight">Access Denied</h1>
        <p className="font-mono text-[12px] text-[#555]">You don&apos;t have permission to access this page.</p>
      </div>
    </div>
  );
}
...
function ProtectedRoutes() {
  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-[#050505] z-[9999] gap-3">
        <div className="w-6 h-6 rounded-full border-2 border-[#1a1a1a] border-t-[#00ff88] animate-spin" />
        <span className="font-mono text-[10px] text-[#555] uppercase tracking-widest">Loading</span>
      </div>
    );
  }

  // Priority 3: Not authenticated - show public routes
  // Header and Footer are rendered inside Home.tsx already
  if (!isAuthenticated) {
    return (
      <Switch>
  ...
  return (
    <div className="flex min-h-screen bg-[#050505]">
      <Sidebar />
      <div className="flex-1 lg:ml-64 min-h-screen bg-[#050505]">
        <Switch>
