  ...
  return (
    <div className="min-h-screen bg-[#050505]">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 gap-3">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div className="min-w-0">
                <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#e0e0e0] truncate">
                  CRM System
                </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-lg sm:text-xl lg:text-2xl font-bold text-[#e0e0e0] mt-1 sm:mt-2">
                    {stat.value}
                  </p>
                </div>
                <div
        ...
        {/* Tabs */}
        <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] mb-6">
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 sm:pl-10 pr-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                </div>
                <select
                  value={filterStatus}
                  onChange={(e) => setFilterStatus(e.target.value)}
                  className="px-3 sm:px-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                >
              ...
              <div className="space-y-3 sm:space-y-4">
                {filteredContacts.map((contact) => (
                  <div
                    key={contact.id}
                    className="border border-[#1a1a1a] rounded-lg p-3 sm:p-4 hover:shadow-md transition-all"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
                        <input
                          ...
                          className="w-4 h-4 text-green-600 border-[#252525] rounded focus:ring-green-500"
                        />
                        <img
                          src={contact.avatar}
                          alt={contact.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <div className="min-w-0 flex-1">
                            <h3 className="font-semibold text-sm sm:text-base text-[#e0e0e0] truncate">
                              {contact.name}
                            </h3>
                            <p className="text-[#999] text-xs sm:text-sm truncate">
                              {contact.company}
                            </p>
                          </div>
                          ...
                          <div className="hidden lg:flex items-center gap-1 flex-shrink-0">
                            <button className="p-2 text-[#555] hover:text-[#999] hover:bg-[#050505] rounded-lg transition-colors">
                          ...
                          <div className="relative lg:hidden flex-shrink-0">
                            <button
                              ...
                              className="p-1.5 text-[#999] hover:bg-[#0a0a0a] rounded-lg transition-colors"
                            ...
                            {openDropdown === contact.id && (
                              <>
                                ...
                                />
                                <div className="absolute right-0 top-full mt-1 w-44 bg-[#0a0a0a] rounded-lg shadow-lg border border-[#1a1a1a] py-1 z-20">
                                  <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#999] hover:bg-[#050505]">
                                    <Eye className="w-4 h-4" />
                                    View
                                  </button>
                                  <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-[#999] hover:bg-[#050505]">
                        ...
                        <div className="space-y-1.5 sm:space-y-2 mb-2 sm:mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            <Phone className="w-3 h-3 sm:w-4 sm:h-4 text-[#555] flex-shrink-0" />
                ...
                {deals.map((deal) => (
                  ...
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-sm sm:text-base text-[#e0e0e0] mb-1">
                          {deal.title}
                        </h3>
                      ...
                      <div className="flex flex-wrap items-center gap-3 sm:gap-6">
                        <div className="flex-1 sm:flex-initial">
                          <div className="text-base sm:text-lg font-bold text-[#e0e0e0]">
                ...
                {activities.map((activity) => (
                  ...
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm sm:text-base text-[#e0e0e0] mb-1">
