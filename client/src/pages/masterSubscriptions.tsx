    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center">
          ...
          <p className="text-[#999]">{t("subscriptions.loading")}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#050505] dots-bg">
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        {/* Desktop Table View */}
        <div className="hidden lg:block overflow-x-auto bg-[#0a0a0a] rounded-lg shadow-sm border border-[#1a1a1a]">
          <table className="min-w-full">
            <thead className="bg-[#050505]">
              <tr>
                <th className="py-3 px-4 text-left text-xs font-semibold text-[#999] uppercase tracking-wider border-b">
            ...
            <tbody className="divide-y divide-gray-200">
              {subscriptions.map(({ subscription, user, plan }) => (
                ...
                >
                  <td className="py-3 px-4 text-sm text-[#e0e0e0]">
                    {user?.username ?? "N/A"}
                  </td>
                  <td className="py-3 px-4 text-sm text-[#e0e0e0]">
                    {plan.name}
                  </td>
                  <td className="py-3 px-4 text-sm text-[#e0e0e0] font-medium">
                  ...
                  <td className="py-3 px-4 text-sm text-[#999]">
        ...
        {/* Pagination Section */}
        <div className="mt-6 bg-[#0a0a0a] rounded-lg shadow-sm border border-[#1a1a1a] p-4">
          {/* Desktop Pagination */}
          <div className="hidden md:flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* Page size dropdown */}
              <select
                className="border border-[#252525] rounded-md px-3 py-1.5 text-sm bg-[#0a0a0a] shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                value={limit}
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                disabled={page === 1}
                className="flex items-center gap-1 px-3 py-2 text-sm border border-[#252525] rounded-md bg-[#0a0a0a] hover:bg-[#050505] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                  ...
                  <button
                    ...
                    className={`px-3 py-2 text-sm border rounded-md transition-colors ${
                      pageNum === page
                        ...
                        : "bg-[#0a0a0a] border-[#252525] hover:bg-[#050505]"
                    }`}
                  >
                    {pageNum}
                  </button>
          ...
          <div className="md:hidden space-y-4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              ...
              <select
                className="border border-[#252525] rounded-md px-3 py-1.5 text-sm bg-[#0a0a0a] shadow-sm w-full sm:w-auto"
                value={limit}
                onChange={(e) => handleLimitChange(Number(e.target.value))}
              >
                {[10, 20, 50, 100].map((size) => (
            ...
            <div className="flex justify-between items-center gap-2">
              <button
                onClick={() => setCurrentPage((p) => Math.max(1, p - 1))}
                disabled={page === 1}
                className="flex-1 flex items-center justify-center gap-1 px-4 py-2 text-sm border border-[#252525] rounded-md bg-[#0a0a0a] hover:bg-[#050505] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <ChevronLeft className="w-4 h-4" />
                {t("subscriptions.pagination.previous")}
              </button>
