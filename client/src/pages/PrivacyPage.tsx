...
//               <p className="text-lg text-[#999] leading-relaxed m-0">
...
//               <div>
//                 <h2 className="text-3xl font-bold mb-4 text-[#e0e0e0]">
//                   1. Information We Collect
//                 </h2>
...
//                   <p className="leading-relaxed">
//                     <strong className="text-[#e0e0e0]">Order History:</strong> A
//                     record of the products you purchase.
//                   </p>

//                   <p className="leading-relaxed">
//                     <strong className="text-[#e0e0e0]">Communication:</strong>{" "}
...
//                   <p className="leading-relaxed">
//                     <strong className="text-[#e0e0e0]">Technical Data:</strong>{" "}
          ...
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <p className="leading-relaxed text-[#999] mt-4">
