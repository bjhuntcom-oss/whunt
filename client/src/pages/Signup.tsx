...
const Signup: React.FC = () => {
  ...
  return (
    <>
      <div className="min-h-screen flex items-center justify-center bg-[#050505] px-4 py-6">
        <div className="max-w-md w-full space-y-8 mt-[50px]">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#555] w-4 h-4" />
                    <input
                      type="text"
                      name="username"
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                        errors.username ? "border-red-300" : "border-[#252525]"
                      }`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-10 pr-4 py-2.5 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                          errors.firstName ? "border-red-300" : "border-[#252525]"
                        }`}
                        placeholder="John"
                        required
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full pl-10 pr-4 py-2.5 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                          errors.lastName ? "border-red-300" : "border-[#252525]"
                        }`}
                        placeholder="Doe"
                        required
                      />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#555] w-4 h-4" />
                    <input
                      type="email"
                      name="email"
                      ...
                      onChange={handleChange}
                      className={`w-full pl-10 pr-4 py-2.5 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                        errors.email ? "border-red-300" : "border-[#252525]"
                      }`}
                ...
                <div>
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#555] w-4 h-4" />
                    <input
                      ...
                      className={`w-full pl-10 pr-12 py-2.5 border rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${
                        errors.password ? "border-red-300" : "border-[#252525]"
                      }`}
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#555] hover:text-[#999]"
                    >
                      {showPassword ? (
                ...
                <div>
                  <label className="flex items-start space-x-3">
                    <input
                      ...
                      onChange={handleChange}
                      className="w-4 h-4 text-green-600 border-[#252525] rounded focus:ring-green-500 mt-0.5"
                    />
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-6 text-sm text-[#555]">
