        ...
        <main className="p-6">
          <Card>
            <CardContent className="py-12 text-center">
              <FileText className="w-12 h-12 mx-auto text-[#555] mb-4" />
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {drafts.map((draft) => (
                    <div
                      key={draft.id}
                      className="flex items-center justify-between bg-[#0a0a0a] rounded-md border border-amber-100 px-3 py-2"
                    >
                ...
                {userRole === "superadmin" ? (
                  <>
                    <div className="hidden lg:block overflow-x-auto">
                      <table className="min-w-full border border-[#1a1a1a] bg-[#0a0a0a] rounded-lg shadow-sm">
                            ...
                            >
                              <td className="py-3 px-4 text-sm text-[#e0e0e0] font-medium">
                                <div className="flex items-center gap-1.5">
                                  {MediaIcon && <MediaIcon className="w-3.5 h-3.5 text-[#555] flex-shrink-0" />}
                              ...
                              <td className="py-3 px-4 text-sm text-[#999]">
                                <span className="inline-flex items-center text-xs">
                                  <Globe className="w-3 h-3 mr-1 text-[#555]" />
                                  {getLanguageLabel(template.language)}
                                </span>
                              </td>
                              <td className="py-3 px-4 text-sm text-[#999] max-w-xs truncate">
                                {template.body}
                              </td>
                              <td className="py-3 px-4">
                                {buttons.length > 0 ? (
                                  <div className="flex flex-wrap gap-1">
                                    {buttons.map((btn, idx) => {
                                      ...
                                      return (
                                        <Badge key={idx} variant="outline" className="text-[10px] px-1.5 py-0 bg-[#050505] text-[#999] border-[#1a1a1a]">
                        ...
                        <Card key={template.id} className="overflow-hidden">
                          <CardContent className="p-4">
                            ...
                            <div className="flex flex-wrap gap-2 mb-3 pb-3 border-b">
                              ...
                              <span className="inline-flex items-center text-[11px] text-[#555]">
                            ...
                            <div className="mb-3">
                              <p className="text-sm text-[#999] line-clamp-3">
                                {template.body}
                              </p>
                            </div>
                            {buttons.length > 0 && (
                              <div className="flex flex-wrap gap-1 mb-3">
                                {buttons.map((btn, idx) => {
                                  const BtnIcon = btnTypeIcons[btn.type] || MousePointerClick;
                                  return (
                                    <Badge key={idx} variant="outline" className="text-[11px] px-1.5 py-0.5 bg-[#050505] text-[#999] border-[#1a1a1a]">
