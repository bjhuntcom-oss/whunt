  ...
  return (
    <div className="min-h-screen bg-[#050505]">
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-teal-500 to-cyan-600 text-white py-28 px-4 sm:px-6 lg:px-8">
        ...
        <div className="absolute top-0 left-0 w-72 h-72 bg-[#0a0a0a]/5 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#0a0a0a]/5 rounded-full translate-x-1/3 translate-y-1/3" />
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center bg-[#0a0a0a]/15 backdrop-blur-md px-5 py-2.5 rounded-full text-sm font-medium mb-10 border border-white/20">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#e0e0e0] mb-6 leading-tight">
              ...
              <p className="text-[#999] mb-5 leading-relaxed text-lg">
                {t("aboutUs.mission.description1")}
              </p>
              <p className="text-[#999] mb-10 leading-relaxed text-lg">
                {t("aboutUs.mission.description2", {
                  appName,
                })}
              </p>
              <div className="grid grid-cols-2 gap-5">
                <div className="bg-[#0a0a0a] p-6 rounded-2xl shadow-sm border border-[#1a1a1a] hover:shadow-md transition-shadow">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-emerald-50 to-cyan-50 rounded-3xl p-10 h-[500px] flex items-center justify-center border border-emerald-100/50">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-[#0a0a0a]/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl max-w-sm border border-white">
                  ...
                  {journeyMilestones.map((milestone, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="pt-1">
                          <div className="font-bold text-[#e0e0e0] text-lg">
                            {milestone.year}
                          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-[#e0e0e0] leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            {valuesList.map((value, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`bg-[#0a0a0a] p-6 rounded-xl shadow-sm border border-[#1a1a1a] border-l-4 ${borderColors[index]} hover:shadow-md transition-all duration-200`}
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#e0e0e0] mb-1.5">
                        {value.title}
                      </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {achievements.map((achievement, index) => {
              ...
              return (
                <div
                  key={index}
                  className="relative bg-[#0a0a0a]/70 backdrop-blur-sm p-8 rounded-2xl shadow-sm border border-[#1a1a1a] hover:shadow-lg transition-all duration-300 group overflow-hidden"
                >
                  ...
                  <div className="font-extrabold text-xl text-[#e0e0e0] mb-1">
                    {achievement.title}
                  </div>
      ...
      <section className="relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-600 via-teal-500 to-cyan-600">
        ...
        <div className="absolute top-0 right-0 w-80 h-80 bg-[#0a0a0a]/5 rounded-full translate-x-1/3 -translate-y-1/3" />
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#0a0a0a]/5 rounded-full -translate-x-1/3 translate-y-1/3" />
        <div className="max-w-3xl mx-auto text-center relative z-10">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center bg-[#0a0a0a] text-emerald-600 px-10 py-4 rounded-2xl font-bold hover:bg-emerald-50 transition-all duration-200 transform hover:scale-105 shadow-xl text-lg"
          >
