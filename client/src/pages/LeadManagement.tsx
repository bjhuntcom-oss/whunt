  ...
  return (
    <div className="min-h-screen bg-[#050505]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Filters and Search */}
        <div className="bg-[#0a0a0a] p-4 sm:p-6 rounded-xl shadow-sm border border-[#1a1a1a] mb-6">
          <div className="flex flex-col lg:flex-row lg:items-center gap-3 sm:gap-4">
            {/* Search */}
            <div className="relative flex-1 min-w-0">
              <Search className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-[#555] w-5 h-5" />
              <input
                type="text"
                placeholder="Search leads..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-10 pr-3 sm:pr-4 py-2 sm:py-2.5 text-sm sm:text-base border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div className="w-full lg:w-auto">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-nowrap gap-2 sm:gap-3">
                <select
                  ...
                  className="w-full px-3 sm:px-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                ...
                <button
                  className="w-full lg:w-auto px-3 sm:px-4 py-2 border border-[#252525] rounded-lg hover:bg-[#050505] transition-colors flex items-center justify-center text-sm sm:text-base"
            ...
            <table className="w-full">
              <thead className="bg-[#050505] border-b border-[#1a1a1a]">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-[#555] uppercase tracking-wider">
                    Lead
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-[#555] uppercase tracking-wider">
                    Company
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredLeads.map((lead) => (
                  <tr key={lead.id} className="hover:bg-[#050505]">
        ...
        {filteredLeads.length === 0 && (
          <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] p-12 text-center">
            <div className="w-16 h-16 bg-[#0a0a0a] rounded-full flex items-center justify-center mx-auto mb-4">
              <UserPlus className="w-8 h-8 text-[#555]" />
            </div>
