        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4">
            <div className="min-w-0">
              <h1 className="truncate text-xl sm:text-2xl font-bold text-[#e0e0e0]">
                Auto Responses
              </h1>
              <p className="hidden sm:block text-sm text-[#999] mt-1">
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-[#0a0a0a] p-4 sm:p-6 rounded-lg shadow-sm border border-[#1a1a1a]"
            >
              <div className="flex items-center justify-between">
                ...
                <div className="p-2 sm:p-3 rounded-lg bg-[#050505]">
                  <stat.icon
        ...
        {/* Filters and Search */}
        <div className="bg-[#0a0a0a] p-4 sm:p-6 rounded-lg shadow-sm border border-[#1a1a1a] mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 sm:pl-10 pr-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
              ...
              <button className="px-3 sm:px-4 py-2 border border-[#252525] rounded-lg hover:bg-[#050505] flex items-center gap-2 text-sm sm:text-base">
        ...
        <div className="space-y-3 sm:space-y-4">
          {filteredResponses.map((response) => (
            <div
              key={response.id}
              className="bg-[#0a0a0a] p-4 sm:p-6 rounded-lg shadow-sm border border-[#1a1a1a] hover:shadow-md transition-shadow"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mb-3">
                    ...
                    <p className="text-xs sm:text-sm text-[#e0e0e0] bg-[#050505] p-2 sm:p-3 rounded-lg break-words">
                      {response.message}
                    </p>
                  </div>

                  <div className="flex flex-wrap items-center gap-3 sm:gap-6 text-xs sm:text-sm text-[#999]">
                ...
                <div className="hidden lg:flex items-center gap-1 flex-shrink-0">
                  ...
                  <button
                    className="p-2 text-[#999] hover:bg-[#050505] rounded-lg transition-colors"
                    title="Copy"
                    aria-label="Copy"
                  >
        ...
        {filteredResponses.length === 0 && (
          <div className="bg-[#0a0a0a] p-8 sm:p-12 rounded-lg shadow-sm border border-[#1a1a1a] text-center">
            <Bot className="w-10 h-10 sm:w-12 sm:h-12 text-[#555] mx-auto mb-4" />
            <h3 className="text-base sm:text-lg font-medium text-[#e0e0e0] mb-2">
              No auto responses found
            </h3>
            <p className="text-sm sm:text-base text-[#999] mb-4">
