  ...
  return (
    <div className="min-h-screen bg-[#050505]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="bg-[#0a0a0a] p-4 sm:p-6 lg:p-8 rounded-xl shadow-sm border border-[#1a1a1a] mb-4 sm:mb-6 lg:mb-8">
          ...
          <div className="lg:hidden">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-medium text-[#e0e0e0] text-sm">
              ...
              <button
                ...
                className="p-2 text-[#555] hover:bg-[#0a0a0a] rounded-lg transition-colors"
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="flex items-center">
                ...
                {index < steps.length - 1 && (
                  <ArrowRight className="w-5 h-5 text-[#555] mx-6 xl:mx-8" />
                )}
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Step 1: Upload File */}
            {activeStep === 1 && (
              <div className="bg-[#0a0a0a] p-4 sm:p-6 lg:p-8 rounded-xl shadow-sm border border-[#1a1a1a]">
                <h2 className="text-lg sm:text-xl font-bold text-[#e0e0e0] mb-4 sm:mb-6">
                  Upload Your File
                </h2>

                <div className="border-2 border-dashed border-[#252525] rounded-lg p-6 sm:p-8 lg:p-12 text-center hover:border-gray-400 transition-colors">
                  <Upload className="w-10 h-10 sm:w-12 sm:h-12 text-[#555] mx-auto mb-3 sm:mb-4" />
              ...
              <div className="bg-[#0a0a0a] p-4 sm:p-6 lg:p-8 rounded-xl shadow-sm border border-[#1a1a1a]">
                ...
                <div className="space-y-3 sm:space-y-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 sm:p-4 bg-[#050505] rounded-lg"
                    >
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        <div className="font-medium text-[#e0e0e0] text-sm sm:text-base">
                          {mapping.csvColumn}
                        </div>
                        <ArrowRight className="w-4 h-4 text-[#555] hidden sm:block" />
                      </div>
                      <div className="flex items-center gap-2">
                        <select
                          defaultValue={mapping.suggestedField}
                          className="flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm sm:text-base border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                ...
                <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:justify-between">
                  <button
                    ...
                    className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base border border-[#252525] rounded-lg text-[#999] hover:bg-[#050505] transition-colors"
                  >
                    Back
                  </button>
                  <button
            ...
            {activeStep === 3 && (
              <div className="bg-[#0a0a0a] p-4 sm:p-6 lg:p-8 rounded-xl shadow-sm border border-[#1a1a1a]">
                ...
                <div className="bg-[#050505] p-3 sm:p-4 rounded-lg mb-4 sm:mb-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
                    <h3 className="font-medium text-[#e0e0e0] text-sm sm:text-base">
                      Data Preview
                    </h3>
                  ...
                  <div className="lg:hidden space-y-3">
                    {[
                      ...
                      <div
                        key={index}
                        className="bg-[#0a0a0a] p-3 rounded-lg border border-[#1a1a1a]"
                      >
                  ...
                  <div className="hidden lg:block overflow-x-auto">
                    <table className="w-full">
                      <thead className="bg-[#0a0a0a]">
                        <tr>
                          <th className="px-4 py-2 text-left text-xs font-medium text-[#555] uppercase">
                            Name
                          </th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-[#555] uppercase">
                            Phone
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {[
                          ...
                          <tr key={index} className="hover:bg-[#050505]">
                            <td className="px-4 py-2 text-sm text-[#e0e0e0]">
                              {record.name}
                            </td>
                            <td className="px-4 py-2 text-sm text-[#e0e0e0]">
                              {record.phone}
            ...
            {activeStep === 4 && (
              <div className="bg-[#0a0a0a] p-4 sm:p-6 lg:p-8 rounded-xl shadow-sm border border-[#1a1a1a]">
                <div className="text-center mb-6 sm:mb-8">
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold text-[#e0e0e0] mb-2">
                    Import Completed!
                  </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  <div className="bg-[#050505] p-3 sm:p-4 rounded-lg">
                    <div className="text-xl sm:text-2xl font-bold text-[#e0e0e0] mb-1">
                      {validationResults.valid}
                    </div>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-3 sm:space-x-4">
                  <button className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base border border-[#252525] rounded-lg text-[#999] hover:bg-[#050505] transition-colors flex items-center justify-center">
                    <Download className="w-4 h-4 mr-2" />
                    Download Report
                  </button>
                  <button
          ...
          <div className="lg:col-span-1 space-y-4 sm:space-y-6">
            ...
            <div className="bg-[#0a0a0a] p-4 sm:p-6 rounded-xl shadow-sm border border-[#1a1a1a]">
              <h3 className="text-base sm:text-lg font-bold text-[#e0e0e0] mb-3 sm:mb-4">
                Recent Imports
              </h3>
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-2">
                      <div className="flex items-start space-x-2 flex-1 min-w-0">
                        <FileText className="w-4 h-4 text-[#555] flex-shrink-0 mt-0.5" />
                        <span className="font-medium text-[#e0e0e0] text-xs sm:text-sm break-all">
                          {history.fileName}
                        </span>
                      </div>
            ...
            <div className="bg-[#0a0a0a] p-4 sm:p-6 rounded-xl shadow-sm border border-[#1a1a1a]">
              ...
              <button className="w-full mt-3 sm:mt-4 bg-[#0a0a0a] text-[#999] py-2 rounded-lg hover:bg-gray-200 transition-colors text-xs sm:text-sm">
                View Import Guide
              </button>
            </div>
          </div>
