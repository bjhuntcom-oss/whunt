...
export default function Plans() {
  ...
  const handleEdit = (plan: Plan): void => {
    ...
    setFormData({
      ...
      badge: plan.badge || "",
      color: plan.color || "border-[#1a1a1a]",
      ...
      <main className="p-6 space-y-6">
        ...
        <Card>
              ...
              <div className="w-full">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-2 flex-wrap min-w-0">
                    <div className="inline-flex items-center gap-2 bg-[#0a0a0a] rounded-lg p-1">
                      <button
                        onClick={() => setIsAnnual(false)}
                        className={`px-4 py-2 rounded-md text-sm font-medium transition-all w-full sm:w-auto text-center ${
                          !isAnnual
                            ? "bg-[#0a0a0a] text-[#e0e0e0] shadow-sm"
          ...
          <CardContent>
            {/* Create/Edit Form */}
            {showForm && (
              <div className="mb-8 p-6 bg-[#050505] rounded-lg border-2 border-[#1a1a1a]">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border border-[#252525] rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                      />
                    </div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-4 py-2 border border-[#252525] rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-none"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    {formData.features.length === 0 ? (
                      <div className="text-center py-8 bg-[#0a0a0a] rounded-lg border-2 border-dashed border-[#252525]">
                        <AlertCircle className="w-12 h-12 text-[#555] mx-auto mb-2" />
                      ...
                      <div className="space-y-2">
                        {formData.features.map((feature, index) => (
                          <div
                            key={index}
                            className="flex items-center gap-2 bg-[#0a0a0a] p-3 rounded-lg border border-[#1a1a1a]"
                          >
                            <input
                              type="text"
                              value={feature.name}
                              ...
                              className="flex-1 px-3 py-1.5 border border-[#252525] rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
                            />
              ...
              if (plans.length === 0) {
                return (
                  <div className="text-center py-12">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-[#0a0a0a] rounded-full mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {plans.map((plan) => {
                    ...
                    return (
                      <div
                        key={plan.id}
                        className={`relative bg-[#0a0a0a] rounded-xl shadow-md border-2 ${
                          plan.color
                      ...
                      >
                        ...
                        <div className="p-6 flex flex-col flex-1">
                          ...
                          <p className="text-sm text-[#999] mb-4 min-h-[40px] line-clamp-2">
                            {plan.description}
                          </p>
                          <div className="mb-4">
                            <div className="flex items-baseline gap-1">
                              <span className="text-3xl font-black text-[#e0e0e0]">
                              ...
                              plan.features.slice(0, 4).map((feature, idx) => (
                                ...
                                >
                                  {feature.included ? (
                                    ...
                                    <X className="w-4 h-4 text-[#555] mt-0.5 flex-shrink-0" />
                                  )}
                                  <span
                                    className={`text-sm ${
                                      feature.included
