...
const EmptyState = ({ onCreateClick }: { onCreateClick: () => void }) => (
  <Card className="border-dashed border-2 border-[#252525]">
    <CardContent className="flex flex-col items-center justify-center py-12 px-4 text-center">
      <div className="rounded-full bg-[#0a0a0a] p-6 mb-4">
        <Users className="h-12 w-12 text-[#555]" />
      </div>
      <h3 className="text-xl font-semibold mb-2 text-[#e0e0e0]">
        No groups yet
      </h3>
      <p className="text-[#555] mb-6 max-w-sm">
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-lg sm:text-xl font-semibold text-[#e0e0e0] truncate">
                          {group.name}
                        </h3>
                        {group.description && (
                          <p className="text-sm sm:text-base text-[#999] mt-1 line-clamp-2">
                            {group.description}
                          </p>
                        )}
      ...
      <Dialog open={openDialog} onOpenChange={setOpenDialog}>
        <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            <div>
              <label className="text-sm font-medium text-[#999] block mb-1.5">
