          ...
          {!selectedTemplate ? (
                  ...
                  {filtered.map((template: any) => {
                    ...
                    return (
                      <div
                        ...
                        className="border rounded-lg p-3.5 cursor-pointer hover:shadow-md hover:border-green-300 transition-all bg-[#0a0a0a] group"
                      >
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="font-semibold text-sm text-[#e0e0e0] truncate flex-1 mr-2">
                            {template.name}
                          </h4>
                        </div>
                        ...
                        {template.header && (
                          <p className="text-sm font-medium text-[#e0e0e0] truncate mb-0.5">
                            {template.header}
                          </p>
                        )}
                        ...
                        {template.footer && (
                          <p className="text-xs text-[#555] italic mt-1">{template.footer}</p>
                        )}
                        {buttons.length > 0 && (
                            ...
                            {buttons.map((button, idx) => {
                              ...
                              return (
                                <Badge
                                  key={idx}
                                  variant="outline"
                                  className="text-[10px] px-1.5 py-0 bg-[#050505] text-[#999] border-[#1a1a1a]"
                                >
            ...
            <div className="space-y-4">
              <div className="p-4 bg-[#050505] rounded-lg">
                ...
                <p className="text-sm text-[#999]">{selectedTemplate.body}</p>
              </div>
...
const MessageComposer = ({
  ...
  return (
    <div className="bg-[#0a0a0a] border-t border-[#1a1a1a] p-3 md:p-4">
      {is24HourWindowExpired &&
      ...
      <div className="flex items-end gap-1 md:gap-2">
        ...
        <textarea
          ...
          rows={1}
          className="flex-1 resize-none rounded-lg border border-[#1a1a1a] bg-[#0a0a0a] px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
