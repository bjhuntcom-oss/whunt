...
const MessageThread = ({
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#050505]">
      <div className="bg-[#0a0a0a] border-b border-[#1a1a1a] px-4 md:px-6 py-3.5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="font-semibold text-[#e0e0e0] text-[15px]">
                  {headerName ||
                      headerPhone ||
                      "Unknown"}
                </h3>
          ...
          <div className="flex items-center gap-1.5">
            {!demo &&
              ...
              <TeamAssignDropdown
                ...
                currentAssigneeName={
                  (selectedConversation as any)?.assignedToName || undefined
                }
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="h-8 w-8 text-[#555] hover:text-[#999]">
      ...
      !isToday(prevDate);
              ...
              {isTyping && (
                <div className="flex items-end gap-2 mb-4">
                  ...
                  <div className="bg-[#0a0a0a] rounded-2xl rounded-bl-sm px-4 py-3">
