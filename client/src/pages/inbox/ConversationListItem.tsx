    ...
    <div
      ...
      className={cn(
        ...
        isSelected
          ...
          : "border-l-[3px] border-l-transparent hover:bg-[#050505]/80"
      )}
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between gap-2 mb-0.5">
          <h4 className="font-semibold text-[14px] text-[#e0e0e0] truncate leading-tight">
            {displayName ||
                displayPhone ||
                "Unknown"}
          </h4>
          <span className="text-[11px] text-[#555] whitespace-nowrap flex-shrink-0 font-medium">
            {lastMessageTime}
          </span>
        </div>
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center min-w-0">
            ...
            <p className="text-[13px] text-[#555] truncate leading-tight">
