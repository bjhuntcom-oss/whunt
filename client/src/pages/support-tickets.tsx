...
export default function SupportTicketsNew() {
  ...
  const adminUsers: AdminUser[] = (adminsData as any)?.admins || [];
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "closed":
        return <XCircle className="w-4 h-4 text-[#555]" />;
      default:
        return <AlertCircle className="w-4 h-4 text-[#555]" />;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            ...
            <div
              key={index}
              className="bg-[#0a0a0a] p-6 rounded-xl shadow-sm border border-[#1a1a1a]"
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#e0e0e0] mt-2">
                    {stat.value}
                  </p>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            {/* Filters and Search */}
            <div className="bg-[#0a0a0a] p-4 rounded-xl shadow-sm border border-[#1a1a1a] mb-4">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#555] w-5 h-5" />
                <input
                  type="text"
                  placeholder="Search tickets..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-10 pr-4 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                />
              </div>
              <div className="flex space-x-2 mt-3">
                <select
                  ...
                  className="flex-1 px-3 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                >
            ...
            {/* Tickets */}
            {isLoading ? (
              <div className="bg-[#0a0a0a] p-8 rounded-xl shadow-sm border border-[#1a1a1a] text-center">
                <div className="text-[#555]">Loading tickets...</div>
              </div>
            ) : (
              <div className="space-y-3">
                {tickets.map((ticket) => (
                  <div
                    ...
                    className={`bg-[#0a0a0a] p-4 rounded-xl shadow-sm border ${
                  ...
                  >
                    ...
                    <h3 className="font-medium text-[#e0e0e0] mb-2">
                      {ticket.title}
                    </h3>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between mt-4 bg-[#0a0a0a] p-3 rounded-lg shadow-sm border border-[#1a1a1a]">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1 text-sm bg-[#0a0a0a] text-[#999] rounded hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
                  <PageNumbers
          ...
          <div className="lg:col-span-2">
            {selectedTicketId && selectedTicket ? (
              <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] overflow-hidden">
                ...
                <div className="p-6 border-b border-[#1a1a1a]">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="flex items-center space-x-2 border border-[#252525] rounded-md px-4 py-2 hover:bg-[#0a0a0a] transition"
                        title="Refresh"
                      >
                        <svg
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="flex items-center mt-1">
                        <Mail className="w-4 h-4 text-[#555] mr-1" />
                    ...
                    <div>
                      <span className="text-[#555]">Details:</span>
                      <div className="flex items-center mt-1">
                        <Calendar className="w-4 h-4 text-[#555] mr-1" />
                      ...
                      <div className="flex items-center mt-1">
                        <Tag className="w-4 h-4 text-[#555] mr-1" />
                        <span
                  ...
                  {isAdmin && (
                    <div className="flex gap-4 mt-4 flex-wrap">
                      <div>
                        <label className="text-xs text-[#555] block mb-1">
                          Status
                        </label>
                        <select
                          value={
                          ...
                          className="px-3 py-1 border border-[#252525] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
                        >
                          <option value="open">Open</option>
                          <option value="in_progress">In Progress</option>
                          <option value="resolved">Resolved</option>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-2 text-sm text-[#e0e0e0] whitespace-pre-wrap">
                ...
                {/* Conversation */}
                <div className="p-6 bg-[#050505] max-h-[300px] overflow-y-auto">
                  <h3 className="font-medium text-[#e0e0e0] mb-4">
                    Conversation
                  </h3>
                ...
                <div className="p-4 border-t border-[#1a1a1a]">
                  <div className="flex items-start space-x-2">
                    <textarea
                      ...
                      className="flex-1 px-4 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
                      rows={3}
                    />
                    <button
                    ...
                    {isAdmin && (
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="rounded border-[#252525] text-green-500 focus:ring-green-500"
                        />
                        <label
                          htmlFor="internal"
              ...
              <div className="bg-[#0a0a0a] p-12 rounded-xl shadow-sm border border-[#1a1a1a] text-center">
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={5}
                className="w-full mt-1 px-3 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
            </div>
            <div>
          ...
          <DialogFooter className="mt-6">
            <button
              ...
              className="px-4 py-2 text-sm text-[#999] bg-[#0a0a0a] rounded-lg hover:bg-gray-200"
            >
              Cancel
            </button>
            <button
