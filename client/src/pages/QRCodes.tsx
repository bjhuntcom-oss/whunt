        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-[#e0e0e0]">QR Codes</h1>
                <p className="text-[#999]">Generate and manage WhatsApp QR codes</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          {[
            ...
            <div key={index} className="bg-[#0a0a0a] p-6 rounded-xl shadow-sm border border-[#1a1a1a]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-[#999]">{stat.title}</p>
                  <p className="text-2xl font-bold text-[#e0e0e0] mt-2">{stat.value}</p>
                </div>
        ...
        {/* Filters and Search */}
        <div className="bg-[#0a0a0a] p-6 rounded-xl shadow-sm border border-[#1a1a1a] mb-6">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <select
              ...
              className="px-4 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
            >
            ...
            <button className="px-4 py-2 border border-[#252525] rounded-lg hover:bg-[#050505] transition-colors flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredQRCodes.map((qrCode) => (
            <div key={qrCode.id} className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] hover:shadow-md transition-all">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <input
                    ...
                    className="w-4 h-4 text-green-600 border-[#252525] rounded focus:ring-green-500 mt-1"
                  />
                ...
                <div className="text-center mb-6">
                  <div className="bg-[#0a0a0a] p-4 rounded-lg mb-4">
                    <QrCode className="w-16 h-16 text-[#999] mx-auto" />
                  </div>
                  <h3 className="text-lg font-semibold text-[#e0e0e0] mb-2">{qrCode.name}</h3>
                </div>

                <div className="space-y-3 mb-6">
                  <div className="flex justify-between items-center">
                    <span className="text-[#999]">Total Scans</span>
                    <span className="font-semibold text-[#e0e0e0]">{qrCode.scans.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#999]">Conversions</span>
                    <span className="font-semibold text-[#e0e0e0]">{qrCode.conversions}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-[#999]">Conversion Rate</span>
                ...
                <div className="flex space-x-2">
                  <button className="flex-1 bg-[#0a0a0a] text-[#999] py-2 px-3 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center text-sm">
                  ...
                  <button className="bg-[#0a0a0a] text-[#999] py-2 px-3 rounded-lg hover:bg-gray-200 transition-colors">
        ...
        {filteredQRCodes.length === 0 && (
          <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] p-12 text-center">
            <div className="w-16 h-16 bg-[#0a0a0a] rounded-full flex items-center justify-center mx-auto mb-4">
              <QrCode className="w-8 h-8 text-[#555]" />
            </div>
            <h3 className="text-lg font-medium text-[#e0e0e0] mb-2">No QR codes found</h3>
