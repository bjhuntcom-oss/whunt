          ...
          <div className="flex flex-wrap items-center justify-between gap-3 py-3 sm:py-4">
            ...
            <div className="flex min-w-0 items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                <h1 className="truncate text-lg font-bold leading-tight text-[#e0e0e0] sm:text-xl lg:text-2xl">
                  AI Assistant
                </h1>
                {/* Hide subtitle on small screens */}
                <p className="hidden text-sm text-[#999] md:block">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a]">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-10 pr-4 py-2 border border-[#252525] rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 text-sm"
                      />
                    </div>
                    <button className="p-2 border border-[#252525] rounded-lg hover:bg-[#050505]">
              ...
              <div className="p-6">
                <div className="space-y-3 sm:space-y-4">
                  {assistants.map((assistant) => (
                    <div
                      key={assistant.id}
                      className="rounded-lg border border-[#1a1a1a] p-3 transition-all hover:shadow-md sm:p-4"
                    >
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-3 sm:gap-4">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mb-2 flex flex-wrap items-center gap-2">
                              <h3 className="text-sm font-semibold text-[#e0e0e0] sm:text-base">
                                {assistant.name}
                              </h3>
                              <span
                              ...
                              <span className="whitespace-nowrap rounded-full bg-[#0a0a0a] px-2 py-0.5 text-xs text-[#999]">
                                {assistant.category}
                              </span>
                            </div>
                            <p className="mb-3 text-xs text-[#999] sm:text-sm">
                        ...
                        <div className="flex items-center justify-end gap-2 border-t border-[#1a1a1a] pt-3 sm:border-t-0 sm:pt-0">
                          ...
                          <button
                            className="flex items-center gap-1.5 rounded-lg bg-[#050505] px-3 py-2 text-sm font-medium text-[#999] transition-colors hover:bg-[#0a0a0a] sm:gap-0 sm:bg-transparent sm:p-2 sm:text-[#555]"
                            aria-label="Edit"
                          >
                          ...
                          <button
                            className="rounded-lg bg-[#050505] p-2 text-[#999] transition-colors hover:bg-[#0a0a0a] sm:bg-transparent sm:text-[#555]"
                            aria-label="More"
                          >
          ...
          <div className="space-y-6">
            {/* AI Suggestions */}
            <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] p-6">
                ...
                {suggestions.map((suggestion, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="font-medium text-[#e0e0e0] text-sm">
                        {suggestion.title}
                      </h4>
                      <span
            ...
            <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-[#999] text-sm">Model Training</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#999] text-sm">Data Processing</span>
                  <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#999] text-sm">Quality Check</span>
                  <div className="flex items-center space-x-2">
            ...
            <div className="bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl p-6 text-white">
              ...
              <div className="space-y-3">
                <button className="w-full bg-[#0a0a0a]/20 backdrop-blur-sm py-2 rounded-lg hover:bg-[#0a0a0a]/30 transition-colors text-sm">
                  Train New Model
                </button>
                <button className="w-full bg-[#0a0a0a]/20 backdrop-blur-sm py-2 rounded-lg hover:bg-[#0a0a0a]/30 transition-colors text-sm">
