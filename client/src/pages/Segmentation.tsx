      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredSegments.map((segment) => (
            <div
              key={segment.id}
              className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] hover:shadow-md transition-all"
            >
              <div className="p-6">
                ...
                <div className="bg-[#050505] p-4 rounded-lg mb-4">
                  <h4 className="text-sm font-medium text-[#999] mb-2">
                    Segment Criteria:
                  </h4>
                  <div className="space-y-2">
                    {segment.criteria.map((criterion, index) => (
                      <div
                        key={index}
                        className="text-sm text-[#999] flex items-center space-x-2"
                      >
        ...
        {filteredSegments.length === 0 && (
          <div className="bg-[#0a0a0a] rounded-xl shadow-sm border border-[#1a1a1a] p-12 text-center">
            <div className="w-16 h-16 bg-[#0a0a0a] rounded-full flex items-center justify-center mx-auto mb-4">
              <Layers className="w-8 h-8 text-[#555]" />
            </div>
