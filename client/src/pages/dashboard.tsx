              ...
              <Card className="hover-lift fade-in">
                <CardContent className="pt-6 pb-4 px-6">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="rounded-lg p-2.5 bg-[rgba(0,255,136,0.07)] text-[#00ff88]">
                      <Send className="w-5 h-5" />
                    </div>
                    <h3 className="text-sm font-medium text-[#999]">Delivery Rate</h3>
                  </div>
              ...
              <Card className="hover-lift fade-in">
                <CardContent className="pt-6 pb-4 px-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-sm font-medium text-[#999]">Read Rate</h3>
                  </div>
                  <div className="text-3xl font-bold text-[#e0e0e0] mb-2">
                    {stats.totalMessages > 0
              ...
              <Card className="hover-lift fade-in">
                <CardContent className="pt-6 pb-4 px-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-sm font-medium text-[#999]">Monthly Growth</h3>
                  </div>
                  {(() => {
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm text-[#555] mb-1">This week</p>
                          <p className="text-2xl font-bold text-[#e0e0e0]">{stats.weekContacts ?? 0}</p>
                        </div>
                        <div className="text-center">
                          ...
                          <p className="text-xs text-[#555]">vs last week</p>
                        </div>
                        <div>
                          <p className="text-sm text-[#555] mb-1">Last week</p>
                          <p className="text-2xl font-bold text-[#555]">{stats.lastWeekContacts ?? 0}</p>
                        </div>
                      </div>
                    );
                  })()}
                ...
                <CardContent>
                  <div className="flex items-center justify-around">
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-[#e0e0e0]">{stats.totalCampaigns ?? 0}</p>
                      <p className="text-sm text-[#555]">Campaigns</p>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-2xl font-bold text-[#e0e0e0]">{stats.totalTemplates ?? 0}</p>
                      <p className="text-sm text-[#555]">Templates</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-4 ">
                ...
                >
                  ...
                  <div>
                    <h4 className=" text-[#e0e0e0] text-xs md:text-sm">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#999] text-nowrap hidden sm:block ">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-3 space-y-2 sm:space-y-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="font-medium text-[#e0e0e0] text-sm sm:text-base truncate">
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div className="text-center p-3 bg-[#050505] rounded-lg">
