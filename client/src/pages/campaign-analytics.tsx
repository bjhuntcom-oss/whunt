...
const SimpleDailyChart = ({ data }: { data: any[] }) => {
    ...
    return (
      <div className="h-64 flex items-center justify-center text-[#555]">
        <div className="text-center">
          <AlertCircle className="w-8 h-8 mx-auto mb-2 text-[#555]" />
  ...
  return (
    <div className="space-y-4">
      ...
      {data.map((item, index) => (
        <div key={index} className="border rounded-lg p-4 bg-[#0a0a0a]">
          <div className="flex justify-between items-center mb-3">
            <span className="font-medium text-[#e0e0e0]">{item.date}</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <p className="text-sm text-[#999]">Type</p>
              ...
              <div>
                <p className="text-sm text-[#999]">Scheduled</p>
                <p className="font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          <Card className="hover-lift">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#999]">Recipients</p>
          ...
          <Card className="hover-lift">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#999]">Messages Sent</p>
                  <p className="text-2xl font-bold text-[#e0e0e0]">
          ...
          <Card className="hover-lift">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#999]">Delivery Rate</p>
          ...
          <Card className="hover-lift">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#999]">Read Rate</p>
          ...
          <Card className="hover-lift">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-[#999]">Failure Rate</p>
            ...
            <CardContent>
              {recipientStats.length > 0 ? (
                  ...
                  {recipientStats.map((stat: any, index: number) => {
                    ...
                    return (
                      <div
                        ...
                        className="flex items-center justify-between p-2 rounded-lg bg-[#050505]"
                      >
                ...
                <div className="h-32 flex items-center justify-center text-[#555]">
                  <div className="text-center">
                    <AlertCircle className="w-6 h-6 mx-auto mb-1 text-[#555]" />
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-[#050505]">
                    <tr>
                      <th className="text-left px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                        Error Code
                      </th>
                      <th className="text-left px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                        Error Message
