          ...
          <CardContent className="p-3 sm:p-4">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="relative w-full sm:w-auto">
                ...
                <div
                  id="export-dropdown"
                  className="hidden absolute right-0 mt-1 w-full sm:w-48 bg-[#0a0a0a] rounded-md shadow-lg z-10 border"
                >
                  <div className="py-1">
                    <button
                      className="flex items-center px-4 py-2 text-xs sm:text-sm text-[#999] hover:bg-[#0a0a0a] w-full"
                      onClick={() => {
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-[#999] mb-1">
                        {t("analytics.OverviewTab.Total_Messages")}
                      </p>
                      <p className="text-xl sm:text-2xl font-bold text-[#e0e0e0] truncate">
              ...
              <Card className="lg:col-span-2">
                ...
                <CardContent className="px-2 sm:px-6 pb-4">
                  {chartData.length > 0 ? (
                    ...
                    // <div className="h-48 sm:h-64 flex items-center justify-center text-[#555] text-sm">
                ...
                <div className="space-y-2">
                  {messageAnalytics?.hourlyDistribution?.map((hour: any) => {
                    ...
                    return (
                      ...
                      >
                        <span className="text-xs sm:text-sm text-[#999] w-10 sm:w-12">
                          {hour.hour}:00
                        </span>
                        ...
                        <span className="text-xs sm:text-sm text-[#999] w-10 sm:w-12 text-right">
                          {hour.count}
                        </span>
                      </div>
                    );
            ...
            {campaignAnalytics?.campaigns?.length === 0 ? (
              <Card>
                <CardContent className="text-center py-8 sm:py-12 px-4">
                  <Target className="w-10 h-10 sm:w-12 sm:h-12 text-[#555] mx-auto mb-3 sm:mb-4" />
                    ...
                    <div className="hidden md:block overflow-x-auto">
                      <table className="w-full">
                        <thead className="bg-[#050505]">
                          <tr>
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                              Campaign
                            </th>
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                              Status
                            ...
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider hidden lg:table-cell">
                              Sent
                            </th>
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                              Delivered
                            </th>
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider hidden xl:table-cell">
                              Read
                            </th>
                            <th className="text-left px-3 lg:px-6 py-3 text-xs font-medium text-[#555] uppercase tracking-wider">
                              Rate
                            ...
                            (campaign: any) => (
                              ...
                              >
                                <td className="px-3 lg:px-6 py-3 lg:py-4">
                                  <div className="text-xs sm:text-sm font-medium text-[#e0e0e0] truncate max-w-[150px]">
                                    {campaign.name}
                                  </div>
                                ...
                                <td className="px-3 lg:px-6 py-3 lg:py-4 text-xs sm:text-sm text-[#e0e0e0]">
                                  {campaign.recipientCount || 0}
                                </td>
                                <td className="px-3 lg:px-6 py-3 lg:py-4 text-xs sm:text-sm text-[#e0e0e0] hidden lg:table-cell">
                                  {campaign.sentCount || 0}
                                </td>
                                <td className="px-3 lg:px-6 py-3 lg:py-4 text-xs sm:text-sm text-[#e0e0e0]">
                                  {campaign.deliveredCount || 0}
                                </td>
                                <td className="px-3 lg:px-6 py-3 lg:py-4 text-xs sm:text-sm text-[#e0e0e0] hidden xl:table-cell">
                      ...
                      {campaignAnalytics?.campaigns?.map((campaign: any) => (
                        ...
                        >
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1 min-w-0">
                              <h3 className="text-sm font-semibold text-[#e0e0e0] truncate">
                                {campaign.name}
                              </h3>
                          ...
                          <div className="grid grid-cols-2 gap-2 text-xs mb-3 pb-3 border-b border-[#1a1a1a]">
                            <div>
                              <span className="text-[#555]">Recipients:</span>
                            ...
                            <div>
                              <span className="text-[#555]">Delivered:</span>
                              <span className="font-medium ml-1">
                                {campaign.deliveredCount || 0}
                              </span>
                            </div>
                            <div>
                              <span className="text-[#555]">Read:</span>
                              <span className="font-medium ml-1">
                                {campaign.readCount || 0}
                              </span>
                            </div>
