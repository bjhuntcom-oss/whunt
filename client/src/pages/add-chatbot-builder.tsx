...
const AddChatbotBuilder = () => {
  ...
  const ChatPreview = () => (
    <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      <div className="w-full max-w-md bg-[#0a0a0a] rounded-2xl shadow-2xl overflow-hidden">
        {/* Chat Header */}
        <div
          ...
          <div className="flex items-center gap-3">
            {config.logoUrl ? (
              <img
                src={config.logoUrl}
                alt="Logo"
                className="w-10 h-10 rounded-full bg-[#0a0a0a] p-1"
              />
            ) : (
              <div
        ...
        {/* Chat Messages */}
        <div className="h-96 overflow-y-auto p-4 space-y-4 bg-[#050505]">
          {messages.map((msg) => (
            <div
              key={msg.id}
              className={`flex ${
            ...
            >
              <div className="flex flex-col max-w-xs">
                ...
                <div
                  className={`rounded-2xl px-4 py-3 ${
                    msg.type === "user"
                      ...
                      : "rounded-tl-none bg-[#0a0a0a] border border-[#1a1a1a] text-[#e0e0e0]"
                  }`}
                  style={
                    msg.type === "user"
                ...
                <span className="text-xs text-[#555] mt-1 px-2">
                  {msg.time}
                </span>
              </div>
            </div>
        ...
        <div className="p-4 bg-[#0a0a0a] border-t border-[#1a1a1a]">
          <div className="flex items-center gap-2 bg-[#0a0a0a] rounded-full px-4 py-2">
            <input
              type="text"
              placeholder="Message..."
              value={inputMessage}
        ...
        {/* Footer */}
        <div className="px-4 pb-3 bg-[#0a0a0a] text-center">
    ...
    <div className="flex-1 dots-bg min-h-screen">
      ...
      <main className="p-6 space-y-6">
        <div className="flex h-screen bg-[#0a0a0a]">
          {/* Left Panel */}
          <div className="w-96 border-r border-[#1a1a1a] overflow-y-auto">
            {/* Steps Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#1a1a1a]">
              {[
                ...
                <div key={s.num} className="flex flex-col items-center">
                  ...
                  <span className="text-xs mt-1 text-[#999]">{s.label}</span>
                </div>
              ))}
            </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-[#252525] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
            ...
            {step === 2 && (
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <label className="cursor-pointer">
                      <div className="w-20 h-20 border-2 border-dashed border-[#252525] rounded-lg flex items-center justify-center hover:border-blue-500 transition-colors">
                        {config.logoUrl ? (
                          <img
                            src={config.logoUrl}
                            alt="Logo"
                          ...
                          <Upload className="text-[#555]" size={24} />
                        )}
                      </div>
                      <input
                        type="file"
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => setStep(1)}
                    className="flex-1 py-3 border border-[#252525] text-[#999] rounded-lg font-semibold hover:bg-[#050505] transition-all"
                  >
                    Back
                  </button>
                  <button
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex gap-2 mb-4">
                  {["Website", "PDF", "Text", "Q&A"].map((tab) => (
                    <button
                      key={tab}
                      className="px-4 py-2 rounded-lg text-sm font-medium bg-[#0a0a0a] hover:bg-gray-200 transition-colors"
                    >
                      {tab}
                    </button>
                  ))}
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 border border-[#252525] rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                      />
                    </div>
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <span className="text-sm text-[#555]">420px</span>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full"
                  />
                  <span className="text-sm text-[#555]">745px</span>
                </div>
