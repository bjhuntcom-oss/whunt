...
const statusColors: Record<string, string> = {
  ...
  inactive: "bg-[#0a0a0a] text-[#e0e0e0]",
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          <select
            ...
            className="border rounded-md px-3 py-2 text-sm bg-[#0a0a0a]"
          >
        ...
        <div className="hidden md:block bg-[#0a0a0a] border rounded-lg shadow-sm overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                <tr>
                  <td colSpan={9} className="py-10 text-center text-[#555]">
                    {t("users.loading")}
                  </td>
                </tr>
              ) : users.length === 0 ? (
                ...
                users.map((u, index) => (
                  <tr key={u.id} className="hover:bg-[#050505]">
                    <td className="px-4 py-3 text-sm text-[#555] font-medium">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-[#555]">{isDemoUser(user?.username) ? maskEmail(u.email) : u.email}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3 text-center">
                      <div className="flex justify-center gap-3 text-[#555]">
                        <FaEdit
                          onClick={() => {
...
/>
        ...
        <div className="md:hidden space-y-4">
          {loading ? (
            <p className="text-center text-[#555] py-10">
              {t("users.loading")}
            </p>
          ) : users.length === 0 ? (
            <p className="text-center text-[#555] py-10">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <span className="text-sm text-[#555] font-medium w-6 text-center flex-shrink-0">
                      {(pagination.page - 1) * pagination.limit + index + 1}
                    </span>
                ...
                <div className="flex justify-end gap-4 pt-2 text-[#555]">
                  <FaEdit
                    onClick={() => {
                      setSelectedUserForEdit(u);
                      setEditModalOpen(true);
