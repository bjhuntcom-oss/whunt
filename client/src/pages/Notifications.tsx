    ...
    <div className="flex-1 min-h-screen dots-bg">
      ...
      <div className="py-8 px-5">
        ...
        <Card className="shadow-sm mt-4">
          <CardHeader className="px-3 sm:px-4 md:px-6 py-3 sm:py-4 border-b border-[#1a1a1a]">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-[#555]">Filters:</span>
              </div>
              <Select
                value={statusFilter}
              ...
              {(statusFilter !== "all" || targetFilter !== "all") && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-xs text-[#555] h-9"
          ...
          <CardContent className="p-0">
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 sm:py-16 px-4">
                <div className="w-16 h-16 sm:w-20 sm:h-20 bg-[#0a0a0a] rounded-full flex items-center justify-center mb-4">
                  <AlertCircle className="w-8 h-8 sm:w-10 sm:h-10 text-[#555]" />
                </div>
                <p className="text-sm sm:text-base font-medium text-[#e0e0e0] mb-2">
              ...
              <>
                ...
                <div className="hidden sm:block overflow-x-auto">
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-[#050505]">
                        <TableHead className="w-[100px] px-3 lg:px-6 py-3 text-xs font-semibold text-[#999] uppercase">
                    ...
                    <TableBody>
                      {paginatedNotifications.map((n) => (
                        <TableRow key={n.id} className="hover:bg-[#050505]">
                          <TableCell className="px-3 lg:px-6 py-3 font-mono text-xs text-[#999]">
                            {String(n.id).slice(0, 8)}
                          </TableCell>
                          <TableCell className="px-3 lg:px-6 py-3 text-sm font-medium text-[#e0e0e0]">
                    ...
                    >
                      <div className="flex items-start justify-between mb-3 gap-2">
                        <div className="flex-1 min-w-0">
                          <h3 className="text-sm font-semibold text-[#e0e0e0] mb-1 line-clamp-2">
                            {_demo ? maskContent(n.title) : n.title}
                          </h3>
        ...
        <Dialog open={showDialog} onOpenChange={setShowDialog}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid gap-6 py-4">
              ...
              {(form.watch("targetType") as string) === "specific" && (
                <div>
